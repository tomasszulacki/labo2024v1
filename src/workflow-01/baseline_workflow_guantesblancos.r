...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_baseline", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_baseline", "DT0001_baseline" )

  DR_drifting_guantesblancos( "DR0001_baseline", "CA0001_baseline" )
  FE_historia_guantesblancos( "FE0001_baseline", "DR0001_baseline" )

  TS_strategy_guantesblancos_202109( "TS0001_baseline", "FE0001_baseline" )

  HT_tuning_guantesblancos( "HT0001_baseline", "TS0001_baseline" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_baseline", c("HT0001_baseline","TS0001_baseline") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_baseline", "FE0001_baseline" )

  HT_tuning_guantesblancos( "HT0002_baseline", "TS0002_baseline" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_baseline", c("HT0002_baseline", "TS0002_baseline") )
...
corrida_guantesblancos_202109( "gb01_baseline" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_baseline" )
