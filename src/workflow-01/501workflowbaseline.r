...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_BS", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_BS", "DT0001_BS" )

  DR_drifting_guantesblancos( "DR0001_BS", "CA0001_BS" )
  FE_historia_guantesblancos( "FE0001_BS", "DR0001_BS" )

  TS_strategy_guantesblancos_202109( "TS0001_BS", "FE0001_BS" )

  HT_tuning_guantesblancos( "HT0001_BS", "TS0001_BS" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_BS", c("HT0001_BS","TS0001_BS") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_BS", "FE0001_BS" )

  HT_tuning_guantesblancos( "HT0002_BS", "TS0002_BS" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_BS", c("HT0002_BS", "TS0002_BS") )
...
corrida_guantesblancos_202109( "gb01_BS" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_BS" )
