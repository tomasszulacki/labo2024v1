...
TS_strategy_guantesblancos_202107 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$train$training <- c(202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007)
  param_local$train$validation <- c(202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202007)
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_5C", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_5C", "DT0001_5C" )

  DR_drifting_guantesblancos( "DR0001_5C", "CA0001_5C" )
  FE_historia_guantesblancos( "FE0001_5C", "DR0001_5C" )

  TS_strategy_guantesblancos_202109( "TS0001_5C", "FE0001_5C" )

  HT_tuning_guantesblancos( "HT0001_5C", "TS0001_5C" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_5C", c("HT0001_5C","TS0001_5C") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_5C", "FE0001_5C" )

  HT_tuning_guantesblancos( "HT0002_5C", "TS0002_5C" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_5C", c("HT0002_5C", "TS0002_5C") )
...
corrida_guantesblancos_202109( "gb01_5C" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_5C" )
