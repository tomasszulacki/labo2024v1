...
# Borrar la columna clase_ternaria si ya no se necesita
...
archivo_salida <- "./exp/HT2020/gridsearch_binariototo.txt"
...
for (vmax_depth in c(4, 6, 8, 10, 12, 14)) {
  for (vmin_split in c(1000, 800, 600, 400, 200, 100, 50, 20, 10)) {
    for(vcp in c(-0.9, -0.7, -0.5, -0.3, -0.1)){
      for(vmin_bucket in c(vmin_split/2,vmin_split/3,vmin_split/4,vmin_split/5)){
